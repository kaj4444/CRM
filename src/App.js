  ...
  const [navOrder, setNavOrder] = useState(() => {
    try {
      ...
      if (saved) {
        ...
        const allIds = ['kanban','table','followup','ukoly','multiplikatori','discovery','email','dokumenty','strategie','produkty','pruvodce']
        const valid = parsed.filter(id => allIds.includes(id))
        const missing = allIds.filter(id => !valid.includes(id))
        return [...valid, ...missing]
      }
    } catch(e) {}
    return ['kanban','table','followup','ukoly','multiplikatori','discovery','email','dokumenty','strategie','produkty','pruvodce']
  })
    ...
    <div className="app-layout">
      ...
      <div className="main">
        <div className="page-header">
          <h1>{{kanban:'Pipeline',table:'Všechny leady',followup:'Follow-up dnes',ukoly:'Úkoly',multiplikatori:'Multiplikátoři',discovery:'Discovery call script',email:'Email šablony',dokumenty:'Dokumenty',strategie:'Strategický plán prodeje',produkty:'Portfolio produktů',pruvodce:'Průvodce strategií'}[tab]}</h1>
